...
| `app.py` | Streamlit 웹앱 — 번호 뽑기 · 인생 시뮬레이터 · 운명의 번호 · 통계 · 역대 조회 |
...
웹앱 재미 기능:
- **💸 인생 시뮬**: 내 번호로 1~최신회차 전부 샀다면 성적표(등수·수익률·손익 그래프),
  그리고 "1등 나올 때까지 산다!!" 버튼 → 보통 수만 년 걸리는 걸 실시간 체험 ㅋㅋ
- **🔮 운명의 번호**: 이름+생년월일+꿈으로 정해지는 오늘의 운명 조합 (과학적 근거 0% 인증)
